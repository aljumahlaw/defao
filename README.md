...
See [railway-setup.md](railway-setup.md) for detailed deployment instructions.

Quick steps:
1. Create Railway project
2. Add PostgreSQL database
3. Set environment variables (see [RAILWAY_ENV_TEMPLATE.md](RAILWAY_ENV_TEMPLATE.md))
...
See [RAILWAY_ENV_TEMPLATE.md](RAILWAY_ENV_TEMPLATE.md) for required environment variables.

## 📚 Documentation

- [Railway Setup](railway-setup.md)
- [Deployment Checklist](DEPLOYMENT_CHECKLIST.md)
- [Railway Environment Template](RAILWAY_ENV_TEMPLATE.md)
- [Phase 4 Deployment](PHASE4_RAILWAY_DEPLOYMENT.md)

For detailed architecture and design documents, see `Archive/` folder.
