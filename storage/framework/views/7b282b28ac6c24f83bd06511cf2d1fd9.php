        ...
        <nav class="flex-1 flex flex-col space-y-1 px-3">
            ...
            <?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e($item['route'] === '#' ? '#' : route($item['route'])); ?>"
                   @click="sidebarOpen = false"
                   <?php if($item['route'] === 'dashboard'): ?>
                       x-on:keydown.ctrl.d="window.location.href='<?php echo e(route('dashboard')); ?>'"
                       title="Ctrl+D - لوحة التحكم"
                   <?php elseif($item['route'] === 'documents.index'): ?>
                       x-on:keydown.ctrl.t="window.location.href='<?php echo e(route('documents.index')); ?>'"
                       title="Ctrl+T - الوثائق"
                   <?php endif; ?>
                   class="group flex items-center gap-3 px-3 py-2 rounded-lg transition-colors <?php echo e($isActive ? 'bg-primary/10 text-primary' : 'hover:bg-primary/10 text-gray-700 dark:text-gray-300 hover:text-primary'); ?>">
                    <?php if($iconComponent === 'heroicon-o-home'): ?>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses(['w-5', 'h-5', 'text-primary' => $isActive, 'text-gray-500' => !$isActive, 'dark:text-gray-400' => !$isActive, 'group-hover:text-primary' => !$isActive]))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <?php elseif($iconComponent === 'heroicon-o-clipboard-document-list'): ?>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <?php elseif($iconComponent === 'heroicon-o-document-text'): ?>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <?php elseif($iconComponent === 'heroicon-o-arrow-path'): ?>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <?php elseif($iconComponent === 'heroicon-o-archive-box'): ?>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <?php elseif($iconComponent === 'heroicon-o-cog-6-tooth'): ?>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                    <?php elseif($iconComponent === 'heroicon-o-user-circle'): ?>
                        <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                    <?php endif; ?>
                    <?php if($item['route'] === 'dashboard'): ?>
                        <span class="<?php echo e($isActive ? 'text-primary' : ''); ?>">لوحة التحكم</span>
                    <?php elseif($item['route'] === 'documents.index'): ?>
                        <span class="<?php echo e($isActive ? 'text-primary' : ''); ?>">الوثائق</span>
                    <?php else: ?>
                        <span class="<?php echo e($isActive ? 'text-primary' : ''); ?>"><?php echo e($item['label']); ?></span>
                    <?php endif; ?>
                </a>
...
<?php /**PATH C:\Users\HP\Desktop\Master\resources\views/components/sidebar.blade.php ENDPATH**/ ?>